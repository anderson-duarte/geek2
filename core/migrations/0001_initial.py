# Generated by Django 3.2 on 2021-04-20 02:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('ini-cog', 'Engrenagem'), ('ini-stats-up', 'Gráfico'), ('ini-users', 'Usuários'), ('ini-layers', 'Design'), ('ini-mobile', 'Mobile'), ('ini-rocket', 'Foguete')], max_length=20, verbose_name='Icone')),
            ],
            options={
